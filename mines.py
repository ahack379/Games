...
# 1) Implement feature to make protective sweeper impossible to click on until you un-right click him
...
sweepImg = pygame.transform.scale(sweepImg, (BOX*3/4, BOX*3/4))
